  ...
  const handleJoinLeave = () => {
    setActivity(prev => {
      ...
      return {
        ...
        currentParticipants: prev.isJoined
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-4 flex items-center gap-2">
          ...
          {/* BOTÓN PARA CONFIGURAR CLIMA VIA PATCH */}
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium">
                {new Date(activity.date).toLocaleString('es-AR', { dateStyle: 'long', timeStyle: 'short' })} hs
              </p>
            </div>
          </div>
        </div>
            ...
            <CardBody>
              ...
              {!activity.isJoined ? (
                ...
                <div className={`rounded-lg p-6 border ${
                  activity.weatherCondition === 'IDEAL'
                    ? 'bg-green-50 border-green-200'
                    : activity.weatherCondition === 'WARNING'
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className={`text-sm mt-1 ${
                        ...
                        {activity.weatherCondition === 'IDEAL'
                          ? 'Todo marcha perfecto para este evento.'
                          : activity.weatherCondition === 'WARNING'
                          ? 'Mantente atento a las notificaciones por si se requiere votación.'
                          : 'Es muy probable que el organizador deba reprogramar.'}
                      </p>
                    </div>
